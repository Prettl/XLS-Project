...
class FindFirstAndLastRowTest {
	...
	static Stream<Arguments> fileToTestProvider() {
	    return Stream.of(
	    		...
	    		Arguments.of("11.xlsx", 7, 22),
	    		Arguments.of("12.xlsx", 7, 18),
	    		Arguments.of("13.xlsx", 7, 19),
	    		Arguments.of("21.xlsx", 7, 15),
	    		Arguments.of("22.xlsx", 7, 18),
	    		Arguments.of("23.xlsx", 7, 18),
	    		Arguments.of("31.xlsx", 7, 28),
	    		Arguments.of("32.xlsx", 7, 29),
	    		Arguments.of("33.xlsx", 7, 29),
